    ...
    function t(m) {
        var l = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
          ...
          , p = function() {
            ...
            t.container && t.container instanceof Object && (n.container = e({}, T.container, t.container)),
            t.template) {
            ...
            return new c((function(e) {
                if (i && -1 === x.indexOf(i))
                    ...
                    if (k.zoomed)
                        ...
                        if (k.original.parentElement && "PICTURE" === k.original.parentElement.tagName && k.original.currentSrc && (k.zoomed.src = k.original.currentSrc),
                        ...
                        k.zoomed.addEventListener("transitionend", (function t() {
                            ...
                            k.original.dispatchEvent(a("medium-zoom:opened", {
                                detail: {
                                    zoom: j
                                }
                            })),
                        ...
                        k.original.getAttribute("data-zoom-src")) {
                            ...
                            var m = setInterval((function() {
                                k.zoomedHd.complete && (clearInterval(m),
          ...
          , E = function() {
            return new c((function(e) {
                if (!A && k.original) {
                    ...
                    k.template && (k.template.style.transition = "opacity 150ms",
                    k.template.style.opacity = 0),
                    k.original.dispatchEvent(a("medium-zoom:close", {
                        detail: {
                            zoom: j
                        }
                    })),
                    k.zoomed.addEventListener("transitionend", (function t() {
                        ...
                        A = !1,
                        k.zoomed.removeEventListener("transitionend", t),
                        k.original.dispatchEvent(a("medium-zoom:closed", {
                            detail: {
                                zoom: j
                            }
                        })),
        ...
        "[object Object]" === Object.prototype.toString.call(m) ? T = m : (m || "string" == typeof m) && v(m),
        T = e({
            margin: 0,
            background: "#fff",
            scrollOffset: 40,
